...
// components
import TableDropdown from "components/Dropdowns/TableBrandDropdown.js";
      ...
      >
              ...
              >
                ...
                <button 
                  ...
                  onClick={()=>{
                    ...
                    showModal(null,'brand-modal')
                  }}>
                  <i className="fas fa-plus"></i> Añadir Marca
                </button>
              </h3>
            </div>
          </div>
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              {query.data.data&&query.data.data.brands.map((brand)=>{
