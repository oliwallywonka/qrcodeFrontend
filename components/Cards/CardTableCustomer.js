...
// components
import TableDropdown from "components/Dropdowns/TableCustomerDropdown.js";
      ...
      >
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              {query.data.data&&query.data.data.customers.map((customer)=>{
                
                return(
                  <tr key={customer._id}>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"> {customer.name}
                    </td>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                      <TableDropdown customer={customer}/>
                    </td>
                  </tr>
                )
